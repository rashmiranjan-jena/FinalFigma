...
const Loads = () => {
  ...
  const availableBalance = tableData.reduce((total, row) => {
    const balance = parseFloat(row.balance.replace('₹', '').replace(',', ''));
    ...
    <div className="loads">
      <div className="header">
        <div className="balance">
          <img src="https://i.pinimg.com/736x/b0/e9/b9/b0e9b9353ed149f37ddf6f25ee1fe1d7.jpg" alt="Balance Icon" />
